                    ...
                    <form action="{{ route('produksi-cutting.store') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="line_cutting" id="line_cutting" class="form-control @error('line_cutting') is-invalid @enderror" value="{{ old('line_cutting') }}" required>
                                @error('line_cutting')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="proses" id="proses" class="form-control @error('proses') is-invalid @enderror" value="{{ old('proses', 'CUTTING') }}">
                                @error('proses')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
