                        ...
                        <table class="table table-bordered table-hover align-middle" style="background: white; border-radius: 12px; overflow: hidden;">
                            ...
                            <tfoot style="background: linear-gradient(135deg, #e8eaf6, #c5cae9); font-weight: bold;">
                                <tr>
                                    ...
                                    <td class="text-end">{{ number_format($produksiCuttings->sum('target')) }}
                                    <td class="text-end">{{ number_format($produksiCuttings->sum('qty')) }}
                                    <td class="text-end">{{ number_format($produksiCuttings->sum('reject')) }}
                                    <td class="text-end">
                                </tr>
                            </tfoot>
                        </table>
...
<div class="modal fade" id="modalMingguanCutting" tabindex="-1" aria-labelledby="modalMingguanCuttingLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('produksi-cutting.mingguan.download') }}" method="POST">
                @csrf
                <div class="modal-body">
                    ...
                    <div class="alert alert-secondary mt-3">
                        ...
                        <small>Laporan akan menampilkan data produksi cutting dalam periode minggu yang dipilih.</small>
                    </div>
                </div>
