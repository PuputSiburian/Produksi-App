    ...
    <div class="card shadow-sm border-0 rounded-3">
        <div class="card-header bg-white py-3">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('produksi-crimping.index') }}" class="btn btn-secondary btn-sm rounded-pill">
        ...
        <div class="card-body">
            <div class="alert alert-info mb-3">
                ...
                ID: {{ $produksiCrimping->id }} | 
                Tanggal: {{ $produksiCrimping->tanggal }} | 
                Line Crimping: {{ $produksiCrimping->line_crimping }} |
                <strong>Leader: {{ $produksiCrimping->leader_name ?? '-' }}</strong>
            </div>
